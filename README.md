...
*Уровень 2:* Канальный уровень (Data Link Layer) обеспечивает связь между двумя напрямую соединенными узлами (node-to-node data transfer). Этот уровень предназначен для обнаружения и исправления ошибок, которые могут возникнуть на физическом уровне. Он определяет протокол для установления и прекращения соединения между двумя физическими подключенными устройствами. Он также определяет протокол для управления потоком данных между ними.   
